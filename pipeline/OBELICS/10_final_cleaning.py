...
NUM_PROC = cpu_count()
NUM_PROC = 2 ## Change while running for more data

PATH_SAVE_DISK_WEB_DOCS_FINAL_CLEANING = os.path.join(PATH_SAVE_DISK_TMP_FILES, "web_docs_finalcleaning")
PATH_SAVE_S3_WEB_DOCS_FINAL_CLEANING = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning/{IDX_JOB}"
...
PATH_SAVE_S3_IMG_URLS_IN_FINAL_WEB_DOCS = (
    f"s3://llm-spark/multi_modal/commoncrawl/webdocs/img_urls_in_final_web_docs/{IDX_JOB}/img_urls.pickle"
)
