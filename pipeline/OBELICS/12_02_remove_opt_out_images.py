...
PATH_OPT_OUT_URLS_S3 = (  # Made by converting s3://llm-spark/multi_modal/commoncrawl/webdocs/ds_opt_out/ to a list and saving in json
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/list_opt_out.json"
)
PATH_OPT_OUT_URLS_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "list_opt_out.json")

PATH_WEB_DOCS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup/{IDX_JOB}/"
PATH_WEB_DOCS_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "web_docs")

NUM_PROC = cpu_count()
NUM_PROC = 1 ## Change when running for more data

PATH_SAVE_DISK_WEB_DOCS_OPT_OUT_FILTERED = os.path.join(PATH_SAVE_DISK_TMP_FILES, "web_docs_optoutrmv")
PATH_SAVE_S3_WEB_DOCS_OPT_OUT_FILTERED = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup_optoutrmv/{IDX_JOB}/"
