...
PATH_NSFW_IMAGE_URLS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/nsfw_image_urls/{IDX_JOB}/nsfw_image_urls.json"
PATH_NSFW_IMAGE_URLS_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "nsfw_image_urls.json")

PATH_WEB_DOCS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup/{IDX_JOB}/"
...
PATH_SAVE_S3_WEB_DOCS_NSFW_FILTERED = os.path.join(
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered", str(IDX_JOB)
)
...
if __name__ == "__main__":
    ...
    print(f"s3 path for image and docs {PATH_WEB_DOCS_S3}")
