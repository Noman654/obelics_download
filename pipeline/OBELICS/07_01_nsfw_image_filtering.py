...
IDX_JOB = sys.argv[1]
PATH_SAVE_DISK_TMP_FILES = f"{root_path}/scratch/storage_hugo_{IDX_JOB}/"

PATH_IMAGE_URLS_IN_WEBDOCS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/image_urls_in_web_document_dataset_filtered/{IDX_JOB}/image_urls_in_web_document_dataset_filtered.pickle"
...
PATH_IMAGE_DATASET_1_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/image_dataset/{IDX_JOB}/"
PATH_IMAGE_DATASET_1_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "image_dataset")

# PATH_IMAGE_DATASET_2_S3 = f"s3://llm-spark/shahrukh/commoncrawl/image_dataset_2/{IDX_JOB}/"
...
PATH_NSFW_CLASSIFIER = (  # Download at https://s3.amazonaws.com/ir_public/nsfwjscdn/nsfw_mobilenet2.224x224.h5
    f"{root_path}/models/nsfw_mobilenet2.224x224.h5"
)
...
PATH_SAVE_S3_NSFW_IMAGES_URLS = os.path.join(
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/nsfw_image_urls", str(IDX_JOB), "nsfw_image_urls.json"
)
...
if __name__ == "__main__":
    ...
    print(f"{PATH_IMAGE_DATASET_1_S3}")
    ...
    nsfw_image_urls = image_dataset_1["url"] 
    #+ image_dataset_2["url"]
