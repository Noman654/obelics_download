...
PATH_DS_IMG_URLS_S3 = (  # Made by concatenating s3://m4-datasets/webdocs/img_urls_in_final_web_docs_2/ + converting to HF dataset
    "s3://llm-spark/multi_modal/commoncrawl/trash/ds_img_urls"
)
root_dir = os.getcwd()
PATH_DS_IMG_URLS_LOCAL = f"{root_dir}/scratch/ds_img_urls"

PATH_SAVE_DISK_OPT_OUT = f"{root_dir}/scratch/ds_opt_out"
PATH_SAVE_S3_OPT_OUT = "s3://llm-spark/multi_modal/commoncrawl/webdocs/ds_opt_out"
