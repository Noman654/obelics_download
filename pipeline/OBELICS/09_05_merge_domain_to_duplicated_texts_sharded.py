...
PATH_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_S3 = (
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/line_dedup_domain_to_duplicated_texts_sharded/"
)
PATH_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_LOCAL = f"{root_dir}/scratch/line_dedup_domain_to_duplicated_texts_sharded/"

PATH_SAVE_DISK_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_FULL = f"{root_dir}/scratch/line_dedup_domain_to_duplicated_texts.json"
PATH_SAVE_S3_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_FULL = (
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/line_dedup_domain_to_duplicated_texts.json"
)

PATH_SAVE_DISK_NEW_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_FULL = (
    f"{root_dir}/scratch/new_line_dedup_domain_to_duplicated_texts.json"
)
PATH_SAVE_S3_NEW_LINE_DEDUP_DOMAIN_TO_DUPLICATED_TEXTS_FULL = (
    "s3://llm-spark/multi_modal/commoncrawl/webdocs/new_line_dedup_domain_to_duplicated_texts.json"
)
