...
PATH_BAN_URL_WARCFILENAME_S3 = "s3://llm-spark/multi_modal/commoncrawl/webdocs/url_to_warcfilename_to_remove.json"
PATH_BAN_URL_WARCFILENAME_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "url_to_warcfilename_to_remove.json")

PATH_WEB_DOCS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning/{IDX_JOB}/"
...
PATH_SAVE_S3_WEB_DOCS_SET_IMG_URLS_DEDUP = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup/{IDX_JOB}/"
...
PATH_SAVE_S3_IMG_URLS_IN_FINAL_WEB_DOCS = (
    f"s3://llm-spark/multi_modal/commoncrawl/webdocs/img_urls_in_final_web_docs_2/{IDX_JOB}/img_urls.pickle"
)
