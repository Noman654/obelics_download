...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="s3://llm-spark/multi_modal/commoncrawl/webdocs/tot_image_urls_in_web_document_dataset_filtered_too_duplicated.pickle",
        help="Path of the file containing the image urls to remove.",
    )
    parser.add_argument(
        "--path_save_web_document_dataset_filtered_imgurldedup",
        type=str,
        default="s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup/",
...
if __name__ == "__main__":
    ...
    path_save_disk_tmp_files = f"{root_dir}/scratch/storage_hugo_{args.idx_job}/"
