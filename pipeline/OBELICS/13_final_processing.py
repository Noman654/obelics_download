...
from obelics.utils.filtering_utils import SPECIAL_CHARACTERS
...
PATH_WEB_DOCS_S3 = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup_optoutrmv/{IDX_JOB}"
PATH_WEB_DOCS_LOCAL = os.path.join(PATH_SAVE_DISK_TMP_FILES, "web_docs")

NUM_PROC = 2  ## Change it when needed

PATH_SAVE_DISK_WEB_DOCS_FINAL_PROCESSING = os.path.join(PATH_SAVE_DISK_TMP_FILES, "web_docs_finalprocessing")
PATH_SAVE_S3_WEB_DOCS_FINAL_PROCESSING = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup_optoutrmv_finalprocessing/{IDX_JOB}"
...
PATH_SAVE_S3_WEB_DOCS_FINAL_PROCESSING_IMAGES_REPLACED_BY_URLS = f"s3://llm-spark/multi_modal/commoncrawl/webdocs/web_document_dataset_filtered_imgurldedup_nsfwfiltered_urldedup_linededup_finalcleaning_setimgurlsdedup_optoutrmv_finalprocessing_replaceimgbyurl/{IDX_JOB}"
...
PATH_SAVE_S3_IMG_URLS_IN_FINAL_WEB_DOCS = (
    f"s3://llm-spark/multi_modal/commoncrawl/webdocs/img_urls_in_final_web_docs_3/{IDX_JOB}/img_urls.pickle"
)
