...
if __name__ == "__main__":
    ...
    path_save_disk_tmp_files = f"{root_path}/scratch/storage_hugo_{args.idx_job}/"
    ...
    logger.info(f"{web_document_dataset_filtered}")
    logger.info("Starting filtering the web document dataset at doc level")
    logger.info(f"{web_document_filtering_doc_level}")
    ...
    logger.info(f"web_document_dataset_filtered is {web_document_dataset_filtered}")
    ...
    print(path_save_disk_web_document_dataset_filtered)
    print(path_sync_s3)
