...
NUM_SHARDS = 200
NUM_SHARDS = 7 ## Change when running for more data
root_dir = os.getcwd()
PATH_SAVE_DISK_TMP_FILES = f"{root_dir}/scratch/storage_hugo/"

PATH_SET_IMG_URLS_S3 = "s3://llm-spark/multi_modal/commoncrawl/webdocs/set_img_urls/"
...
PATH_SAVE_S3_URL_TO_WARCFILENAME_TO_REMOVE = "s3://llm-spark/multi_modal/commoncrawl/webdocs/url_to_warcfilename_to_remove.json"
